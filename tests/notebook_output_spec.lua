describe("Notebook output buffer", function()
	...
	it("opens full text in an unwrapped scratch buffer", function()
		require("config.notebook_output").open(source, 2)
